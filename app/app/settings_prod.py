...
import os
from config import MONGODB_USER, MONGODB_PASSWORD, MONGODB_CLUSTER, SECRET_KEY
...
DATABASES = {
    'default': {
        ...
        'NAME': 'driveyou_db',
        'CLIENT': {
            'host': f'mongodb+srv://{MONGODB_USER}:{MONGODB_PASSWORD}@{MONGODB_CLUSTER}.mongodb.net/?retryWrites=true&w=majority',
